...
const inverterTypes = {
  'On-grid Inverter': ['Solplanet', 'Involtics', 'GoodWe'],
  'Hybrid Inverter': ['Involtics', 'GoodWe', 'Sunways'],
};
...
const products = [
  ...
  },
  {
    ...
    specifications: {
      ...
      'Power Output': '570â€“585Wp',
      'Efficiency': 'Up to 22.66%',
      'Bifaciality Factor': '80% Â±10%',
  ...
  },
  {
    ...
    specifications: {
      ...
      'Temperature Coefficient': '-0.29%/Â°C',
  ...
  // Solplanet ON GRID Inverters â€” ASW S2 Series (1-Phase, 1 MPPT)
  {
    id: 'solplanet-asw-1000-s2',
    name: 'ASW 1000-S2',
    ...
    capacity: '1kW',
    price: 14100,
    benefit: 'Single-phase 1 MPPT on-grid inverter with Wi-Fi monitoring',
    image: inverterImg,
    warranty: '10 Years',
    connectivity: 'WiFi',
    specifications: {
    ...
    features: ['Single-phase output', '1 MPPT tracker', 'Built-in WiFi monitoring', '10-year warranty'],
  },
  {
    id: 'solplanet-asw-2000-s2',
    name: 'ASW 2000-S2',
    category: 'Solar Inverters',
    inverterType: 'On-grid Inverter',
    brand: 'Solplanet',
  ...
  // Solplanet ON GRID Inverters â€” ASW S-G2 Series (1-Phase, 2 MPPT)
  {
    id: 'solplanet-asw-1000-s-g2',
    name: 'ASW 1000-S-G2',
    category: 'Solar Inverters',
    inverterType: 'On-grid Inverter',
    brand: 'Solplanet',
    capacity: '1kW',
    price: 17200,
    benefit: 'Single-phase 2-MPPT second-generation on-grid inverter with WiFi',
    image: inverterImg,
    warranty: '10 Years',
    connectivity: 'WiFi',
    specifications: {
    ...
    features: ['Single-phase output', '2 MPPT trackers', 'Built-in WiFi monitoring', '10-year warranty'],
  },
  {
    id: 'solplanet-asw-1500-s-g2',
    name: 'ASW 1500-S-G2',
    category: 'Solar Inverters',
    inverterType: 'On-grid Inverter',
    brand: 'Solplanet',
  ...
  },
  {
    ...
    capacity: '8kW',
    price: 46000,
    benefit: 'Single-phase 2-MPPT high-power on-grid inverter with WiFi',
    image: inverterImg,
    warranty: '10 Years',
    connectivity: 'WiFi',
    specifications: {
  ...
  // Solplanet ON GRID Inverters â€” ASW LT-G2 Pro Series (3-Phase)
  {
    id: 'solplanet-asw-3k-lt-g2-pro',
    name: 'ASW 3K-LT-G2 Pro',
    category: 'Solar Inverters',
    inverterType: 'On-grid Inverter',
    brand: 'Solplanet',
    capacity: '3kW',
    price: 46500,
    benefit: 'Three-phase on-grid inverter with WiFi monitoring',
    image: inverterImg,
    warranty: '10 Years',
    connectivity: 'WiFi',
    specifications: {
    ...
    features: ['Three-phase output', 'Advanced MPPT', 'Built-in WiFi monitoring', '10-year warranty'],
  },
  {
    id: 'solplanet-asw-4k-lt-g2-pro',
    name: 'ASW 4K-LT-G2 Pro',
    category: 'Solar Inverters',
    inverterType: 'On-grid Inverter',
    brand: 'Solplanet',
    capacity: '4kW',
  ...
  {
    id: 'solplanet-asw-5k-lt-g2-pro',
    name: 'ASW 5K-LT-G2 Pro',
    category: 'Solar Inverters',
    inverterType: 'On-grid Inverter',
    brand: 'Solplanet',
    capacity: '5kW',
  ...
  {
    id: 'solplanet-asw-6k-lt-g2-pro',
    name: 'ASW 6K-LT-G2 Pro',
    category: 'Solar Inverters',
    inverterType: 'On-grid Inverter',
    brand: 'Solplanet',
    capacity: '6kW',
  ...
  {
    id: 'solplanet-asw-8k-lt-g2-pro',
    name: 'ASW 8K-LT-G2 Pro',
    category: 'Solar Inverters',
    inverterType: 'On-grid Inverter',
    brand: 'Solplanet',
    capacity: '8kW',
  ...
  {
    id: 'solplanet-asw-10k-lt-g2-pro',
    name: 'ASW 10K-LT-G2 Pro',
    category: 'Solar Inverters',
    inverterType: 'On-grid Inverter',
    brand: 'Solplanet',
    capacity: '10kW',
  ...
  {
    id: 'solplanet-asw-12k-lt-g2-pro',
    name: 'ASW 12K-LT-G2 Pro',
    category: 'Solar Inverters',
    inverterType: 'On-grid Inverter',
    brand: 'Solplanet',
    capacity: '12kW',
  ...
  {
    id: 'solplanet-asw-13k-lt-g2-pro',
    name: 'ASW 13K-LT-G2 Pro',
    category: 'Solar Inverters',
    inverterType: 'On-grid Inverter',
    brand: 'Solplanet',
    capacity: '13kW',
  ...
  {
    id: 'solplanet-asw-15k-lt-g2-pro',
    name: 'ASW 15K-LT-G2 Pro',
    category: 'Solar Inverters',
    inverterType: 'On-grid Inverter',
    brand: 'Solplanet',
    capacity: '15kW',
  ...
  {
    id: 'solplanet-asw-17k-lt-g2-pro',
    name: 'ASW 17K-LT-G2 Pro',
    category: 'Solar Inverters',
    inverterType: 'On-grid Inverter',
    brand: 'Solplanet',
    capacity: '17kW',
  ...
  {
    id: 'solplanet-asw-20k-lt-g2-pro',
    name: 'ASW 20K-LT-G2 Pro',
    category: 'Solar Inverters',
    inverterType: 'On-grid Inverter',
    brand: 'Solplanet',
    capacity: '20kW',
  ...
  // Solplanet ON GRID Inverters â€” ASW LT-G3 W/ AFCI Series (3-Phase)
  {
    id: 'solplanet-asw-25k-lt-g3-afci',
    name: 'ASW 25K-LT-G3 W/ AFCI',
    category: 'Solar Inverters',
    inverterType: 'On-grid Inverter',
    brand: 'Solplanet',
    capacity: '25kW',
    price: 97900,
    benefit: 'Three-phase on-grid inverter with AFCI protection and WiFi monitoring',
    image: inverterImg,
    warranty: '10 Years',
    connectivity: 'WiFi',
    specifications: {
      'Phase': '3-Phase',
      'Rated Power': '25 kW',
      'Safety': 'AFCI Protection',
      'Warranty': '10 Years',
      'Connectivity': 'WiFi',
    },
    features: ['Three-phase output', 'AFCI arc fault protection', 'Built-in WiFi monitoring', '10-year warranty'],
  },
  {
    id: 'solplanet-asw-30k-lt-g3-afci',
    name: 'ASW 30K-LT-G3 W/ AFCI',
    category: 'Solar Inverters',
    inverterType: 'On-grid Inverter',
    brand: 'Solplanet',
    capacity: '30kW',
  ...
  {
    id: 'solplanet-asw-33k-lt-g3-afci',
    name: 'ASW 33K-LT-G3 W/ AFCI',
    category: 'Solar Inverters',
    inverterType: 'On-grid Inverter',
    brand: 'Solplanet',
    capacity: '33kW',
  ...
  {
    id: 'solplanet-asw-36k-lt-g3-afci',
    name: 'ASW 36K-LT-G3 W/ AFCI',
    category: 'Solar Inverters',
    inverterType: 'On-grid Inverter',
    brand: 'Solplanet',
    capacity: '36kW',
  ...
  {
    id: 'solplanet-asw-40k-lt-g3-afci',
    name: 'ASW 40K-LT-G3 W/ AFCI',
    category: 'Solar Inverters',
    inverterType: 'On-grid Inverter',
    brand: 'Solplanet',
    capacity: '40kW',
  ...
  },
  {
    ...
    capacity: '45kW',
    price: 130900,
    benefit: 'Three-phase high-power on-grid inverter with WiFi monitoring',
    image: inverterImg,
    warranty: '10 Years',
    connectivity: 'WiFi',
    specifications: {
  ...
  },
  {
    ...
    capacity: '50kW',
    price: 138900,
    benefit: 'Three-phase high-power commercial on-grid inverter with WiFi monitoring',
    image: inverterImg,
    warranty: '10 Years',
    connectivity: 'WiFi',
    specifications: {
  ...
  // â”€â”€â”€ INVOLTICS Inverters â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

  // INVOLTICS Hybrid Inverters â€” 1-Phase
  {
    id: 'involtics-gtsi-0304k1p',
    name: 'GTSI-0304K1P',
    category: 'Solar Inverters',
    ...
    capacity: '3kW',
    price: 69000,
    benefit: 'Single-phase 1-MPPT hybrid inverter compatible with Lead Acid & Lithium batteries',
    image: inverterImg,
    warranty: '5 Years',
    connectivity: 'WiFi',
    specifications: {
    ...
    features: ['Single-phase hybrid output', '1 MPPT tracker', 'Lead Acid & Lithium compatible', 'Built-in WiFi monitoring'],
  },
  {
    id: 'involtics-gtsi-3605k1p',
    name: 'GTSI-3.605K1P',
    category: 'Solar Inverters',
    inverterType: 'Hybrid Inverter',
    brand: 'Involtics',
    capacity: '3.6kW',
    price: 75000,
    benefit: 'Single-phase 2-MPPT hybrid inverter compatible with Lead Acid & Lithium batteries',
    image: inverterImg,
    warranty: '5 Years',
    connectivity: 'WiFi',
    specifications: {
    ...
    features: ['Single-phase hybrid output', '2 MPPT trackers', 'Lead Acid & Lithium compatible', 'Built-in WiFi monitoring'],
  },
  {
    id: 'involtics-gtsi-0506k1p',
    name: 'GTSI-0506K1P',
    category: 'Solar Inverters',
    inverterType: 'Hybrid Inverter',
    brand: 'Involtics',
  ...
  // INVOLTICS Hybrid Inverters â€” 3-Phase
  {
    id: 'involtics-gtsi-0506k-3p',
    name: 'GTSI-0506K-3P',
    category: 'Solar Inverters',
    inverterType: 'Hybrid Inverter',
    brand: 'Involtics',
    capacity: '5kW',
    price: 152000,
    benefit: 'Three-phase 2-MPPT hybrid inverter compatible with Lead Acid & Lithium batteries',
    image: inverterImg,
    warranty: '5 Years',
    connectivity: 'WiFi',
    specifications: {
    ...
    features: ['Three-phase hybrid output', '2 MPPT trackers', 'Lead Acid & Lithium compatible', 'Built-in WiFi monitoring'],
  },
  {
    id: 'involtics-gtsi-0608k-3p',
    name: 'GTSI-0608K-3P',
    category: 'Solar Inverters',
    inverterType: 'Hybrid Inverter',
    brand: 'Involtics',
  ...
  // INVOLTICS ON GRID Inverters â€” 1-Phase
  {
    id: 'involtics-gt-1-5k-1p-c01',
    name: 'GT 1.5K-1P C01',
    category: 'Solar Inverters',
    inverterType: 'On-grid Inverter',
    brand: 'Involtics',
    capacity: '1.5kW',
    price: 13900,
    benefit: 'Single-phase 1-MPPT on-grid inverter with WiFi monitoring',
    image: inverterImg,
    warranty: '10 Years',
    connectivity: 'WiFi',
    specifications: {
  ...
  // INVOLTICS ON GRID Inverters â€” 3-Phase
  {
    id: 'involtics-gt-5-0k-3p-c01',
    name: 'GT 5.0K 3P C01',
    category: 'Solar Inverters',
    inverterType: 'On-grid Inverter',
    brand: 'Involtics',
    capacity: '5kW',
    price: 38350,
    benefit: 'Three-phase 2-MPPT on-grid inverter with WiFi monitoring',
    image: inverterImg,
    warranty: '10 Years',
    connectivity: 'WiFi',
    specifications: {
    ...
    features: ['Three-phase output', '2 MPPT trackers', 'Built-in WiFi monitoring', '10-year warranty'],
  },
  {
    id: 'involtics-gt-6-0k-3p-c01',
    name: 'GT 6.0K 3P C01',
    category: 'Solar Inverters',
    inverterType: 'On-grid Inverter',
    brand: 'Involtics',
  ...
  // GoodWe Hybrid Inverters
  {
    ...
    warranty: '5 Years',
    connectivity: 'WiFi',
    specifications: { 'Phase': '1-Phase', 'MPPT': '1 MPPT', 'Rated Power': '3 kW', 'Battery Compatibility': 'Lead Acid & Lithium', 'Warranty': '5 Years', 'Connectivity': 'WiFi' },
    features: ['Single-phase hybrid output', '1 MPPT tracker', 'Lead Acid & Lithium compatible', 'Built-in WiFi monitoring'],
  },
  {
    id: 'goodwe-gw5000es-c10',
    name: 'GW5000ES-C10',
    category: 'Solar Inverters',
    inverterType: 'Hybrid Inverter',
    brand: 'GoodWe',
    ...
    warranty: '5 Years',
    connectivity: 'WiFi',
    specifications: { 'Phase': '1-Phase', 'MPPT': '2 MPPT', 'Rated Power': '5 kW', 'Battery Compatibility': 'Lead Acid & Lithium', 'Warranty': '5 Years', 'Connectivity': 'WiFi' },
    features: ['Single-phase hybrid output', '2 MPPT trackers', 'Lead Acid & Lithium compatible', 'Built-in WiFi monitoring'],
  },
  {
    id: 'goodwe-gw10ket-l-g10',
    name: 'GW10KET-L-G10',
    category: 'Solar Inverters',
    inverterType: 'Hybrid Inverter',
    brand: 'GoodWe',
    capacity: '10kW',
    price: 184000,
    benefit: 'Three-phase hybrid inverter compatible with Lead Acid & Lithium batteries',
    image: inverterImg,
    warranty: '5 Years',
    connectivity: 'WiFi',
    specifications: { 'Phase': '3-Phase', 'Rated Power': '10 kW', 'Battery Compatibility': 'Lead Acid & Lithium', 'Warranty': '5 Years', 'Connectivity': 'WiFi' },
    features: ['Three-phase hybrid output', 'Lead Acid & Lithium compatible', 'Built-in WiFi monitoring'],
  },
  {
    id: 'goodwe-gw15ket-l-g15',
    name: 'GW15KET-L-G15',
    category: 'Solar Inverters',
    inverterType: 'Hybrid Inverter',
    brand: 'GoodWe',
    capacity: '15kW',
    price: 208000,
    benefit: 'Three-phase 4-MPPT hybrid inverter compatible with Lead Acid & Lithium batteries',
    image: inverterImg,
    warranty: '5 Years',
    connectivity: 'WiFi',
    specifications: { 'Phase': '3-Phase', 'MPPT': '4 MPPT', 'Rated Power': '15 kW', 'Battery Compatibility': 'Lead Acid & Lithium', 'Warranty': '5 Years', 'Connectivity': 'WiFi' },
    features: ['Three-phase hybrid output', '4 MPPT trackers', 'Lead Acid & Lithium compatible', 'Built-in WiFi monitoring'],
  },
  {
    id: 'goodwe-gw20ket-l-g20',
    name: 'GW20KET-L-G20',
    category: 'Solar Inverters',
    inverterType: 'Hybrid Inverter',
    brand: 'GoodWe',
    ...
    warranty: '5 Years',
    connectivity: 'WiFi',
    specifications: { 'Phase': '3-Phase', 'MPPT': '4 MPPT', 'Rated Power': '20 kW', 'Battery Compatibility': 'Lead Acid & Lithium', 'Warranty': '5 Years', 'Connectivity': 'WiFi' },
    features: ['Three-phase hybrid output', '4 MPPT trackers', 'Lead Acid & Lithium compatible', 'Built-in WiFi monitoring'],
  },

  // GoodWe ON GRID Inverters
  {
    id: 'goodwe-i-gw1000-xs',
    name: 'I-GW1000-XS',
    category: 'Solar Inverters',
    inverterType: 'On-grid Inverter',
    brand: 'GoodWe',
    ...
    warranty: '8 Years',
    connectivity: 'WiFi',
    specifications: { 'Phase': '1-Phase', 'MPPT': '1 MPPT', 'Rated Power': '1 kW', 'Warranty': '8 Years', 'Connectivity': 'WiFi' },
    features: ['Single-phase output', '1 MPPT tracker', 'Built-in WiFi monitoring', '8-year warranty'],
  },
  {
    id: 'goodwe-i-gw1000-xs-11',
    name: 'I-GW1000-XS-11',
    category: 'Solar Inverters',
    inverterType: 'On-grid Inverter',
    brand: 'GoodWe',
  ...
  },
  {
    ...
    warranty: '8 Years',
    connectivity: 'WiFi',
    specifications: { 'Phase': '1-Phase', 'MPPT': '1 MPPT', 'Rated Power': '3 kW', 'Warranty': '8 Years', 'Connectivity': 'WiFi' },
    features: ['Single-phase output', '1 MPPT tracker', 'Built-in WiFi monitoring', '8-year warranty'],
  },
  {
    id: 'goodwe-i-gw300-xs-11',
    name: 'I-GW300-XS-11',
    category: 'Solar Inverters',
    inverterType: 'On-grid Inverter',
    brand: 'GoodWe',
    ...
    warranty: '8 Years',
    connectivity: 'WiFi',
    specifications: { 'Phase': '1-Phase', 'MPPT': '1 MPPT', 'Rated Power': '3.3 kW', 'Warranty': '8 Years', 'Connectivity': 'WiFi' },
    features: ['Single-phase output', '1 MPPT tracker', 'Built-in WiFi monitoring', '8-year warranty'],
  },
  {
    id: 'goodwe-i-gw3300-xs-30',
    name: 'I-GW3300-XS 30',
    category: 'Solar Inverters',
    inverterType: 'On-grid Inverter',
    brand: 'GoodWe',
  ...
  {
    id: 'goodwe-i-gw4200-dns-30',
    name: 'I-GW4200 DNS 30',
    category: 'Solar Inverters',
    inverterType: 'On-grid Inverter',
    brand: 'GoodWe',
    capacity: '4.2kW',
    price: 30600,
    benefit: 'Single-phase 2-MPPT on-grid inverter with WiFi monitoring',
    image: inverterImg,
    warranty: '8 Years',
    connectivity: 'WiFi',
    specifications: { 'Phase': '1-Phase', 'MPPT': '2 MPPT', 'Rated Power': '4.2 kW', 'Warranty': '8 Years', 'Connectivity': 'WiFi' },
    features: ['Single-phase output', '2 MPPT trackers', 'Built-in WiFi monitoring', '8-year warranty'],
  },
  {
    id: 'goodwe-i-gw5000-dns-30',
    name: 'I-GW5000 DNS 30',
    category: 'Solar Inverters',
    inverterType: 'On-grid Inverter',
    brand: 'GoodWe',
    capacity: '5kW',
    ...
    warranty: '8 Years',
    connectivity: 'WiFi',
    specifications: { 'Phase': '1-Phase', 'MPPT': '2 MPPT', 'Rated Power': '5 kW', 'Warranty': '8 Years', 'Connectivity': 'WiFi' },
    features: ['Single-phase output', '2 MPPT trackers', 'Built-in WiFi monitoring', '8-year warranty'],
  },
  {
    id: 'goodwe-i-gw5000-sdt-20',
    name: 'I-GW5000-SDT-20',
    category: 'Solar Inverters',
    inverterType: 'On-grid Inverter',
    brand: 'GoodWe',
    capacity: '5.5kW',
    ...
    warranty: '10 Years',
    connectivity: 'WiFi',
    specifications: { 'Phase': '3-Phase', 'MPPT': '2 MPPT', 'Rated Power': '5.5 kW', 'Connectivity': 'WiFi' },
    features: ['Three-phase output', '2 MPPT trackers', 'Built-in WiFi monitoring'],
  },
  {
    id: 'goodwe-i-gw6000-dns-30',
    name: 'I-GW6000-DNS-30',
    category: 'Solar Inverters',
    inverterType: 'On-grid Inverter',
    brand: 'GoodWe',
    capacity: '6kW',
    ...
    warranty: '10 Years',
    connectivity: 'WiFi',
    specifications: { 'Phase': '3-Phase', 'MPPT': '2 MPPT', 'Rated Power': '6 kW', 'Connectivity': 'WiFi' },
    features: ['Three-phase output', '2 MPPT trackers', 'Built-in WiFi monitoring'],
  },
  {
    id: 'goodwe-i-gw6000-sdt-20',
    name: 'I-GW6000-SDT-20',
    category: 'Solar Inverters',
    inverterType: 'On-grid Inverter',
    brand: 'GoodWe',
    capacity: '6.6kW',
    ...
    warranty: '10 Years',
    connectivity: 'WiFi',
    specifications: { 'Phase': '3-Phase', 'MPPT': '2 MPPT', 'Rated Power': '6.6 kW', 'Connectivity': 'WiFi' },
    features: ['Three-phase output', '2 MPPT trackers', 'Built-in WiFi monitoring'],
  },
  {
    id: 'goodwe-i-gw8000-sdt-20',
    name: 'I-GW8000-SDT-20',
    category: 'Solar Inverters',
    inverterType: 'On-grid Inverter',
    brand: 'GoodWe',
    capacity: '8.8kW',
    ...
    warranty: '10 Years',
    connectivity: 'WiFi',
    specifications: { 'Phase': '3-Phase', 'MPPT': '2 MPPT', 'Rated Power': '8.8 kW', 'Connectivity': 'WiFi' },
    features: ['Three-phase output', '2 MPPT trackers', 'Built-in WiFi monitoring'],
  },
  {
    id: 'goodwe-i-gw10k-sdt-20',
    name: 'I-GW10K-SDT-20',
    category: 'Solar Inverters',
    inverterType: 'On-grid Inverter',
    brand: 'GoodWe',
    ...
    warranty: '10 Years',
    connectivity: 'WiFi',
    specifications: { 'Phase': '3-Phase', 'MPPT': '2 MPPT', 'Rated Power': '10 kW', 'Connectivity': 'WiFi' },
    features: ['Three-phase output', '2 MPPT trackers', 'Built-in WiFi monitoring'],
  },
  {
    id: 'goodwe-i-gw15k-sdt-20',
    name: 'I-GW15K-SDT-20',
    category: 'Solar Inverters',
    inverterType: 'On-grid Inverter',
    brand: 'GoodWe',
    ...
    warranty: '10 Years',
    connectivity: 'WiFi',
    specifications: { 'Phase': '3-Phase', 'MPPT': '2 MPPT', 'Rated Power': '15 kW', 'Warranty': '5 Years', 'Connectivity': 'WiFi' },
    features: ['Three-phase output', '2 MPPT trackers', 'Built-in WiFi monitoring'],
  },
  {
    id: 'goodwe-i-gw20k-sdt-20',
    name: 'I-GW20K-SDT-20',
    category: 'Solar Inverters',
    inverterType: 'On-grid Inverter',
    brand: 'GoodWe',
    ...
    warranty: '10 Years',
    connectivity: 'WiFi',
    specifications: { 'Phase': '3-Phase', 'MPPT': '2 MPPT', 'Rated Power': '20 kW', 'Connectivity': 'WiFi' },
    features: ['Three-phase output', '2 MPPT trackers', 'Built-in WiFi monitoring'],
  },
  {
    id: 'goodwe-i-gw25k-mt',
    name: 'I-GW25K-MT',
    category: 'Solar Inverters',
    inverterType: 'On-grid Inverter',
    brand: 'GoodWe',
    capacity: '25kW',
    price: 105500,
    benefit: 'Three-phase commercial on-grid inverter with WiFi monitoring',
    image: inverterImg,
    warranty: '10 Years',
    connectivity: 'WiFi',
    specifications: { 'Phase': '3-Phase', 'Rated Power': '25 kW', 'Connectivity': 'WiFi' },
    features: ['Three-phase output', 'Built-in WiFi monitoring'],
  },
  {
    id: 'goodwe-gw-30kw',
    name: 'GW 30KW',
    ...
    warranty: '10 Years',
    connectivity: 'WiFi',
    specifications: { 'Phase': '3-Phase', 'Rated Power': '30 kW', 'Connectivity': 'WiFi' },
    features: ['Three-phase output', 'Built-in WiFi monitoring'],
  },
  {
    id: 'goodwe-gw-36kw',
    ...
    warranty: '10 Years',
    connectivity: 'WiFi',
    specifications: { 'Phase': '3-Phase', 'Rated Power': '36 kW', 'Connectivity': 'WiFi' },
    features: ['Three-phase output', 'Built-in WiFi monitoring'],
  },
  {
    id: 'goodwe-i-gw50k-mt',
    name: 'I-GW50K-MT',
    category: 'Solar Inverters',
    inverterType: 'On-grid Inverter',
    brand: 'GoodWe',
    capacity: '50kW',
    price: 165900,
    benefit: 'Three-phase 6-MPPT high-power on-grid inverter with WiFi monitoring',
    image: inverterImg,
    warranty: '10 Years',
    connectivity: 'WiFi',
    specifications: { 'Phase': '3-Phase', 'MPPT': '6 MPPT', 'Rated Power': '50 kW', 'Connectivity': 'WiFi' },
    features: ['Three-phase output', '6 MPPT trackers', 'Built-in WiFi monitoring'],
  },
  {
    id: 'goodwe-i-gw60k-mt',
    name: 'I-GW60K-MT',
    category: 'Solar Inverters',
    inverterType: 'On-grid Inverter',
    brand: 'GoodWe',
    ...
    warranty: '10 Years',
    connectivity: 'WiFi',
    specifications: { 'Phase': '3-Phase', 'MPPT': '6 MPPT', 'Rated Power': '60 kW', 'Connectivity': 'WiFi' },
    features: ['Three-phase output', '6 MPPT trackers', 'Built-in WiFi monitoring'],
  },
  {
    id: 'goodwe-i-gw80k-mt',
    name: 'I-GW80K-MT',
    category: 'Solar Inverters',
    inverterType: 'On-grid Inverter',
    brand: 'GoodWe',
    ...
    warranty: '10 Years',
    connectivity: 'WiFi',
    specifications: { 'Phase': '3-Phase', 'MPPT': '10 MPPT', 'Rated Power': '80 kW', 'Connectivity': 'WiFi' },
    features: ['Three-phase output', 'High-power commercial use', 'Built-in WiFi monitoring'],
  },
  {
    id: 'goodwe-i-gw100k-ht',
    name: 'I-GW100K-HT',
    category: 'Solar Inverters',
    inverterType: 'On-grid Inverter',
    brand: 'GoodWe',
    capacity: '100kW',
    price: 276900,
    benefit: 'Three-phase utility-scale on-grid inverter with WiFi monitoring',
    image: inverterImg,
    warranty: '10 Years',
    connectivity: 'WiFi',
    specifications: { 'Phase': '3-Phase', 'MPPT': '10 MPPT', 'Rated Power': '100 kW', 'Connectivity': 'WiFi' },
    features: ['Three-phase output', 'Utility-scale capacity', 'Built-in WiFi monitoring'],
  },
  {
    id: 'goodwe-i-gw120k-ht',
    name: 'I-GW120K-HT',
    category: 'Solar Inverters',
    inverterType: 'On-grid Inverter',
    brand: 'GoodWe',
    ...
    warranty: '10 Years',
    connectivity: 'WiFi',
    specifications: { 'Phase': '3-Phase', 'MPPT': '12 MPPT', 'Rated Power': '120 kW', 'Connectivity': 'WiFi' },
    features: ['Three-phase output', 'Utility-scale capacity', 'Built-in WiFi monitoring'],
  },
  {
    id: 'goodwe-i-gw125k-ht',
    name: 'I-GW125K-HT',
    category: 'Solar Inverters',
    inverterType: 'On-grid Inverter',
    brand: 'GoodWe',
    ...
    warranty: '10 Years',
    connectivity: 'WiFi',
    specifications: { 'Phase': '3-Phase', 'MPPT': '12 MPPT', 'Rated Power': '125 kW', 'Connectivity': 'WiFi' },
    features: ['Three-phase output', 'Utility-scale capacity', 'Built-in WiFi monitoring'],
  },
  {
    id: 'goodwe-i-gw250k-ht',
    name: 'I-GW250K-HT',
    category: 'Solar Inverters',
    inverterType: 'On-grid Inverter',
    brand: 'GoodWe',
    capacity: '250kW',
    price: 389000,
    benefit: 'Three-phase large-scale commercial on-grid inverter with WiFi monitoring',
    image: inverterImg,
    warranty: '10 Years',
    connectivity: 'WiFi',
    specifications: { 'Phase': '3-Phase', 'Rated Power': '250 kW', 'Connectivity': 'WiFi' },
    features: ['Three-phase output', 'Large-scale commercial use', 'Built-in WiFi monitoring'],
  },

  // ─── Sunways Hybrid Inverters ─────────────────────────────────────────────
  {
    id: 'sunways-sth-3ktl-ls',
    name: 'STH-3KTL-LS',
    category: 'Solar Inverters',
    inverterType: 'Hybrid Inverter',
    brand: 'Sunways',
    capacity: '3kW',
    price: 64000,
    benefit: 'Single-phase 1-MPPT hybrid inverter with WiFi monitoring',
    image: inverterImg,
    warranty: '5 Years',
    connectivity: 'WiFi',
    specifications: { 'Phase': '1-Phase', 'MPPT': '1 MPPT', 'Rated Power': '3 kW', 'Connectivity': 'WiFi' },
    features: ['Single-phase hybrid output', '1 MPPT tracker', 'Built-in WiFi monitoring'],
  },
  {
    id: 'sunways-sth-5ktl-ls',
    name: 'STH-5KTL-LS',
    category: 'Solar Inverters',
    inverterType: 'Hybrid Inverter',
    brand: 'Sunways',
    capacity: '5kW',
    price: 68500,
    benefit: 'Single-phase 2-MPPT hybrid inverter with WiFi monitoring',
    image: inverterImg,
    warranty: '5 Years',
    connectivity: 'WiFi',
    specifications: { 'Phase': '1-Phase', 'MPPT': '2 MPPT', 'Rated Power': '5 kW', 'Connectivity': 'WiFi' },
    features: ['Single-phase hybrid output', '2 MPPT trackers', 'Built-in WiFi monitoring'],
  },
  {
    id: 'sunways-sth-8ktl-ls',
    name: 'STH-8KTL-LS',
    category: 'Solar Inverters',
    inverterType: 'Hybrid Inverter',
    brand: 'Sunways',
    ...
    warranty: '5 Years',
    connectivity: 'WiFi',
    specifications: { 'Phase': '1-Phase', 'MPPT': '2 MPPT', 'Rated Power': '8 kW', 'Connectivity': 'WiFi' },
    features: ['Single-phase hybrid output', '2 MPPT trackers', 'Built-in WiFi monitoring'],
  },
  {
    id: 'sunways-sth-6ktl-ht',
    name: 'STH-6KTL-HT',
    category: 'Solar Inverters',
    inverterType: 'Hybrid Inverter',
    brand: 'Sunways',
    capacity: '6kW',
    price: 86712,
    benefit: 'Three-phase 2-MPPT hybrid inverter with WiFi monitoring',
    image: inverterImg,
    warranty: '5 Years',
    connectivity: 'WiFi',
    specifications: { 'Phase': '3-Phase', 'MPPT': '2 MPPT', 'Rated Power': '6 kW', 'Connectivity': 'WiFi' },
    features: ['Three-phase hybrid output', '2 MPPT trackers', 'Built-in WiFi monitoring'],
  },
  {
    id: 'sunways-sth-8ktl-ht',
    name: 'STH-8KTL-HT',
    category: 'Solar Inverters',
    inverterType: 'Hybrid Inverter',
    brand: 'Sunways',
    ...
    warranty: '5 Years',
    connectivity: 'WiFi',
    specifications: { 'Phase': '3-Phase', 'MPPT': '2 MPPT', 'Rated Power': '8 kW', 'Connectivity': 'WiFi' },
    features: ['Three-phase hybrid output', '2 MPPT trackers', 'Built-in WiFi monitoring'],
  },
  {
    id: 'sunways-sth-10ktl-ht',
    name: 'STH-10KTL-HT',
    category: 'Solar Inverters',
    inverterType: 'Hybrid Inverter',
    brand: 'Sunways',
  ...
  },
  {
    ...
    warranty: '5 Years',
    connectivity: 'WiFi',
    specifications: { 'Phase': '3-Phase', 'MPPT': '2 MPPT', 'Rated Power': '15 kW', 'Connectivity': 'WiFi' },
    features: ['Three-phase hybrid output', '2 MPPT trackers', 'Built-in WiFi monitoring'],
  },
  {
    id: 'sunways-sth-20ktl-ht',
    name: 'STH-20KTL-HT',
    category: 'Solar Inverters',
    inverterType: 'Hybrid Inverter',
    brand: 'Sunways',
  ...
  },
  {
    ...
    warranty: '5 Years',
    connectivity: 'WiFi',
    specifications: { 'Phase': '3-Phase', 'MPPT': '2 MPPT', 'Rated Power': '25 kW', 'Connectivity': 'WiFi' },
    features: ['Three-phase hybrid output', '2 MPPT trackers', 'Built-in WiFi monitoring'],
  },
  {
    id: 'sunways-sth-30ktl-ht',
    name: 'STH-30KTL-HT',
    category: 'Solar Inverters',
    inverterType: 'Hybrid Inverter',
    brand: 'Sunways',
    ...
    warranty: '5 Years',
    connectivity: 'WiFi',
    specifications: { 'Phase': '3-Phase', 'MPPT': '2 MPPT', 'Rated Power': '30 kW', 'Connectivity': 'WiFi' },
    features: ['Three-phase hybrid output', '2 MPPT trackers', 'Built-in WiFi monitoring'],
  },
  {
    id: 'sunways-sth-33ktl-ht',
    name: 'STH-33KTL-HT',
    category: 'Solar Inverters',
    inverterType: 'Hybrid Inverter',
    brand: 'Sunways',
    ...
    warranty: '5 Years',
    connectivity: 'WiFi',
    specifications: { 'Phase': '3-Phase', 'MPPT': '2 MPPT', 'Rated Power': '33 kW', 'Connectivity': 'WiFi' },
    features: ['Three-phase hybrid output', '2 MPPT trackers', 'Built-in WiFi monitoring'],
  },
